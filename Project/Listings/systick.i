# 1 "../Hardware/systick/systick.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Hardware/systick/systick.c" 2
# 37 "../Hardware/systick/systick.c"
...
# 38 "../Hardware/systick/systick.c" 2
...
# 39 "../Hardware/systick/systick.c" 2
...
void systick_config(void)
{
    ...
    __NVIC_SetPriority(SysTick_IRQn, 0x01U);
}
