# 1 "../Basic/Source/gd32e23x_dma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Basic/Source/gd32e23x_dma.c" 2
# 37 "../Basic/Source/gd32e23x_dma.c"
...
# 38 "../Basic/Source/gd32e23x_dma.c" 2
# 47 "../Basic/Source/gd32e23x_dma.c"
void dma_deinit(dma_channel_enum channelx)
{
...
# 97 "../Basic/Source/gd32e23x_dma.c"
void dma_init(dma_channel_enum channelx, dma_parameter_struct* init_struct)
{
    uint32_t ctl;
...
# 312 "../Basic/Source/gd32e23x_dma.c"
void dma_memory_width_config(dma_channel_enum channelx, uint32_t mwidth)
{
    uint32_t ctl;
...
# 337 "../Basic/Source/gd32e23x_dma.c"
void dma_periph_width_config(dma_channel_enum channelx, uint32_t pwidth)
{
    uint32_t ctl;
...
# 357 "../Basic/Source/gd32e23x_dma.c"
void dma_memory_increase_enable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x08U) + 0x14U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(7)));
}
# 370 "../Basic/Source/gd32e23x_dma.c"
void dma_memory_increase_disable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x08U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(7)));
}
# 383 "../Basic/Source/gd32e23x_dma.c"
void dma_periph_increase_enable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x08U) + 0x14U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(6)));
}
# 396 "../Basic/Source/gd32e23x_dma.c"
void dma_periph_increase_disable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x08U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(6)));
}
# 413 "../Basic/Source/gd32e23x_dma.c"
void dma_transfer_direction_config(dma_channel_enum channelx, uint8_t direction)
{
...
# 436 "../Basic/Source/gd32e23x_dma.c"
FlagStatus dma_flag_get(dma_channel_enum channelx, uint32_t flag)
{
    FlagStatus reval;
