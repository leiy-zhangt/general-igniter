# 1 "../CMSIS/Source/system_gd32e23x.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../CMSIS/Source/system_gd32e23x.c" 2
# 36 "../CMSIS/Source/system_gd32e23x.c"
...
# 37 "../CMSIS/Source/system_gd32e23x.c" 2
# 61 "../CMSIS/Source/system_gd32e23x.c"
uint32_t SystemCoreClock = (uint32_t)(72000000);
static void system_clock_72m_hxtal(void);
# 74 "../CMSIS/Source/system_gd32e23x.c"
...
# 182 "../CMSIS/Source/system_gd32e23x.c"
static void system_clock_72m_hxtal(void)
{
    uint32_t timeout = 0U;
    ...
    do{
        timeout++;
        stab_flag = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(17))));
    }
    while((0U == stab_flag) && (((uint16_t)0x0FFFF) != timeout));

    if(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(17))))){
        while(1){
        }
    }
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x04U)) &= ~(((uint32_t)((uint32_t)0x01U<<(16))) | (((uint32_t)((uint32_t)0x01U<<(27))) | ((0xFFFFFFFFUL << (18)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(21))))) | ((uint32_t)((uint32_t)0x01U<<(31))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x04U)) |= (((uint32_t)((uint32_t)0x01U<<(16))) | (((0xFFFFFFFFUL << (18)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(21)))) & ((uint32_t)(7) << 18)));
...
# 320 "../CMSIS/Source/system_gd32e23x.c"
