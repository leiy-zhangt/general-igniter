# 1 "../Hardware/fuse/fuse.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Hardware/fuse/fuse.c" 2
...
# 5 "../Hardware/fuse/fuse.h" 2
# 14 "../Hardware/fuse/fuse.h"
void fuse_config(void);
# 2 "../Hardware/fuse/fuse.c" 2
void fuse_config(void)
{

 rcu_periph_clock_enable(RCU_GPIOA);

 gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), ((uint32_t)((uint32_t)0x01U<<(9)))|((uint32_t)((uint32_t)0x01U<<(10))));
 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),((uint8_t)(0x00U)),(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)),((uint32_t)((uint32_t)0x01U<<(9)))|((uint32_t)((uint32_t)0x01U<<(10))));
 gpio_bit_reset(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),((uint32_t)((uint32_t)0x01U<<(9)))|((uint32_t)((uint32_t)0x01U<<(10))));
}
