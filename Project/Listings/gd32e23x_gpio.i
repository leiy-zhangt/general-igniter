# 1 "../Basic/Source/gd32e23x_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Basic/Source/gd32e23x_gpio.c" 2
# 37 "../Basic/Source/gd32e23x_gpio.c"
...
# 38 "../Basic/Source/gd32e23x_gpio.c" 2
# 47 "../Basic/Source/gd32e23x_gpio.c"
void gpio_deinit(uint32_t gpio_periph)
{
    switch(gpio_periph){
...
# 95 "../Basic/Source/gd32e23x_gpio.c"
void gpio_mode_set(uint32_t gpio_periph, uint32_t mode, uint32_t pull_up_down, uint32_t pin)
{
    uint16_t i;
    uint32_t ctl, pupd;
...
# 139 "../Basic/Source/gd32e23x_gpio.c"
void gpio_output_options_set(uint32_t gpio_periph, uint8_t otype, uint32_t speed, uint32_t pin)
{
    uint16_t i;
    uint32_t ospeed;
...
# 228 "../Basic/Source/gd32e23x_gpio.c"
void gpio_port_write(uint32_t gpio_periph, uint16_t data)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x14U)) = (uint32_t)data;
}
# 244 "../Basic/Source/gd32e23x_gpio.c"
FlagStatus gpio_input_bit_get(uint32_t gpio_periph, uint32_t pin)
{
...
# 261 "../Basic/Source/gd32e23x_gpio.c"
uint16_t gpio_input_port_get(uint32_t gpio_periph)
{
    return (uint16_t)(*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x10U));
}
# 277 "../Basic/Source/gd32e23x_gpio.c"
FlagStatus gpio_output_bit_get(uint32_t gpio_periph, uint32_t pin)
{
...
# 294 "../Basic/Source/gd32e23x_gpio.c"
uint16_t gpio_output_port_get(uint32_t gpio_periph)
{
    return (uint16_t)(*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x14U));
}
# 320 "../Basic/Source/gd32e23x_gpio.c"
void gpio_af_set(uint32_t gpio_periph, uint32_t alt_func_num, uint32_t pin)
{
    uint16_t i;
    uint32_t afrl, afrh;
...
# 359 "../Basic/Source/gd32e23x_gpio.c"
void gpio_pin_lock(uint32_t gpio_periph, uint32_t pin)
{
...
# 383 "../Basic/Source/gd32e23x_gpio.c"
void gpio_bit_toggle(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x2CU)) = (uint32_t)pin;
}
# 396 "../Basic/Source/gd32e23x_gpio.c"
void gpio_port_toggle(uint32_t gpio_periph)
{
