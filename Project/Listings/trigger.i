# 1 "../Hardware/trigger/trigger.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Hardware/trigger/trigger.c" 2
# 1 "../Hardware/trigger/trigger.h" 1
...
# 5 "../Hardware/trigger/trigger.h" 2
...
# 2 "../Hardware/trigger/trigger.c" 2
void trigger_config(void)
{

    rcu_periph_clock_enable(RCU_GPIOA);

    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(8))));
}
