# 1 "../Basic/Source/gd32e23x_rtc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Basic/Source/gd32e23x_rtc.c" 2
# 37 "../Basic/Source/gd32e23x_rtc.c"
...
# 38 "../Basic/Source/gd32e23x_rtc.c" 2
...
# 112 "../Basic/Source/gd32e23x_rtc.c"
ErrStatus rtc_init(rtc_parameter_struct* rtc_initpara_struct)
{
    ErrStatus error_status = ERROR;
...
# 205 "../Basic/Source/gd32e23x_rtc.c"
ErrStatus rtc_register_sync_wait(void)
{
...
# 258 "../Basic/Source/gd32e23x_rtc.c"
void rtc_current_time_get(rtc_parameter_struct* rtc_initpara_struct)
{
...
# 316 "../Basic/Source/gd32e23x_rtc.c"
void rtc_alarm_config(rtc_alarm_struct* rtc_alarm_time)
{
...
# 329 "../Basic/Source/gd32e23x_rtc.c"
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002800U)) + 0x00000024U)) = ((uint8_t)0xCAU);
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002800U)) + 0x00000024U)) = ((uint8_t)0x53U);
...
# 362 "../Basic/Source/gd32e23x_rtc.c"
void rtc_alarm_subsecond_config(uint32_t mask_subsecond, uint32_t subsecond)
{
...
# 444 "../Basic/Source/gd32e23x_rtc.c"
void rtc_alarm_get(rtc_alarm_struct* rtc_alarm_time)
{
    uint32_t reg_alrm0td = 0x00U;
...
# 482 "../Basic/Source/gd32e23x_rtc.c"
void rtc_timestamp_enable(uint32_t edge)
{
...
# 538 "../Basic/Source/gd32e23x_rtc.c"
void rtc_timestamp_get(rtc_timestamp_struct* rtc_timestamp)
{
...
# 586 "../Basic/Source/gd32e23x_rtc.c"
void rtc_tamper_enable(rtc_tamper_struct* rtc_tamper)
{
...
# 632 "../Basic/Source/gd32e23x_rtc.c"
void rtc_tamper_disable(uint32_t source)
{
...
# 649 "../Basic/Source/gd32e23x_rtc.c"
void rtc_interrupt_enable(uint32_t interrupt)
{
...
# 674 "../Basic/Source/gd32e23x_rtc.c"
void rtc_interrupt_disable(uint32_t interrupt)
{
...
# 707 "../Basic/Source/gd32e23x_rtc.c"
FlagStatus rtc_flag_get(uint32_t flag)
{
...
# 789 "../Basic/Source/gd32e23x_rtc.c"
ErrStatus rtc_calibration_config(uint32_t window, uint32_t plus, uint32_t minus)
{
...
# 824 "../Basic/Source/gd32e23x_rtc.c"
void rtc_hour_adjust(uint32_t operation)
{
...
# 846 "../Basic/Source/gd32e23x_rtc.c"
ErrStatus rtc_second_adjust(uint32_t add, uint32_t minus)
{
    uint32_t time_index = ((uint32_t)0x00001000U);
    ErrStatus error_status = ERROR;
