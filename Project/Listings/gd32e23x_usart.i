# 1 "../Basic/Source/gd32e23x_usart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Basic/Source/gd32e23x_usart.c" 2
# 37 "../Basic/Source/gd32e23x_usart.c"
...
# 38 "../Basic/Source/gd32e23x_usart.c" 2
...
# 70 "../Basic/Source/gd32e23x_usart.c"
void usart_baudrate_set(uint32_t usart_periph, uint32_t baudval)
{
...
# 112 "../Basic/Source/gd32e23x_usart.c"
void usart_parity_config(uint32_t usart_periph, uint32_t paritycfg)
{
...
# 132 "../Basic/Source/gd32e23x_usart.c"
void usart_word_length_set(uint32_t usart_periph, uint32_t wlen)
{
...
# 154 "../Basic/Source/gd32e23x_usart.c"
void usart_stop_bit_set(uint32_t usart_periph, uint32_t stblen)
{
...
# 195 "../Basic/Source/gd32e23x_usart.c"
void usart_transmit_config(uint32_t usart_periph, uint32_t txconfig)
{
...
# 212 "../Basic/Source/gd32e23x_usart.c"
void usart_receive_config(uint32_t usart_periph, uint32_t rxconfig)
{
...
# 229 "../Basic/Source/gd32e23x_usart.c"
void usart_data_first_config(uint32_t usart_periph, uint32_t msbf)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));
...
# 253 "../Basic/Source/gd32e23x_usart.c"
void usart_invert_config(uint32_t usart_periph, usart_invert_enum invertpara)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));
...
# 323 "../Basic/Source/gd32e23x_usart.c"
void usart_oversample_config(uint32_t usart_periph, uint32_t oversamp)
{
...
# 342 "../Basic/Source/gd32e23x_usart.c"
void usart_sample_bit_config(uint32_t usart_periph, uint32_t osb)
{
...
# 380 "../Basic/Source/gd32e23x_usart.c"
void usart_receiver_timeout_threshold_config(uint32_t usart_periph, uint32_t rtimeout)
{
...
# 393 "../Basic/Source/gd32e23x_usart.c"
void usart_data_transmit(uint32_t usart_periph, uint32_t data)
{
...
# 441 "../Basic/Source/gd32e23x_usart.c"
void usart_autobaud_detection_mode_config(uint32_t usart_periph, uint32_t abdmod)
{
...
# 455 "../Basic/Source/gd32e23x_usart.c"
void usart_address_config(uint32_t usart_periph, uint8_t addr)
{
...
# 474 "../Basic/Source/gd32e23x_usart.c"
void usart_address_detection_mode_config(uint32_t usart_periph, uint32_t addmod)
{
...
# 515 "../Basic/Source/gd32e23x_usart.c"
void usart_mute_mode_wakeup_config(uint32_t usart_periph, uint32_t wmethod)
{
...
# 562 "../Basic/Source/gd32e23x_usart.c"
void usart_lin_break_detection_length_config(uint32_t usart_periph, uint32_t lblen)
{
...
# 644 "../Basic/Source/gd32e23x_usart.c"
void usart_synchronous_clock_config(uint32_t usart_periph, uint32_t clen, uint32_t cph, uint32_t cpl)
{
...
# 663 "../Basic/Source/gd32e23x_usart.c"
void usart_guard_time_config(uint32_t usart_periph, uint32_t guat)
{
...
# 757 "../Basic/Source/gd32e23x_usart.c"
void usart_smartcard_autoretry_config(uint32_t usart_periph, uint32_t scrtnum)
{
...
# 772 "../Basic/Source/gd32e23x_usart.c"
void usart_block_length_config(uint32_t usart_periph, uint32_t bl)
{
...
# 813 "../Basic/Source/gd32e23x_usart.c"
void usart_prescaler_config(uint32_t usart_periph, uint32_t psc)
{
...
# 831 "../Basic/Source/gd32e23x_usart.c"
void usart_irda_lowpower_config(uint32_t usart_periph, uint32_t irlp)
{
...
# 849 "../Basic/Source/gd32e23x_usart.c"
void usart_hardware_flow_rts_config(uint32_t usart_periph, uint32_t rtsconfig)
{
...
# 868 "../Basic/Source/gd32e23x_usart.c"
void usart_hardware_flow_cts_config(uint32_t usart_periph, uint32_t ctsconfig)
{
...
# 887 "../Basic/Source/gd32e23x_usart.c"
void usart_hardware_flow_coherence_config(uint32_t usart_periph, uint32_t hcm)
{
...
# 928 "../Basic/Source/gd32e23x_usart.c"
void usart_driver_assertime_config(uint32_t usart_periph, uint32_t deatime)
{
...
# 944 "../Basic/Source/gd32e23x_usart.c"
void usart_driver_deassertime_config(uint32_t usart_periph, uint32_t dedtime)
{
...
# 963 "../Basic/Source/gd32e23x_usart.c"
void usart_depolarity_config(uint32_t usart_periph, uint32_t dep)
{
...
# 982 "../Basic/Source/gd32e23x_usart.c"
void usart_dma_receive_config(uint32_t usart_periph, uint32_t dmacmd)
{
...
# 999 "../Basic/Source/gd32e23x_usart.c"
void usart_dma_transmit_config(uint32_t usart_periph, uint32_t dmacmd)
{
...
# 1067 "../Basic/Source/gd32e23x_usart.c"
void usart_wakeup_mode_config(uint32_t usart_periph, uint32_t wum)
{
...
# 1143 "../Basic/Source/gd32e23x_usart.c"
FlagStatus usart_flag_get(uint32_t usart_periph, usart_flag_enum flag)
{
...
# 1227 "../Basic/Source/gd32e23x_usart.c"
void usart_interrupt_disable(uint32_t usart_periph, usart_interrupt_enum inttype)
{
    ((*(volatile uint32_t *)(uint32_t)((usart_periph) + (((uint32_t)(inttype) & 0x0000FFFFU) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(inttype) & 0x0000001FU))));
}
# 1245 "../Basic/Source/gd32e23x_usart.c"
void usart_command_enable(uint32_t usart_periph, uint32_t cmdtype)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000018U)) |= (cmdtype);
}
# 1274 "../Basic/Source/gd32e23x_usart.c"
FlagStatus usart_interrupt_flag_get(uint32_t usart_periph, usart_interrupt_flag_enum int_flag)
{
...
# 1311 "../Basic/Source/gd32e23x_usart.c"
void usart_interrupt_flag_clear(uint32_t usart_periph, usart_interrupt_flag_enum flag)
{
