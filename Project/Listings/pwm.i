# 1 "../Hardware/pwm/pwm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Hardware/pwm/pwm.c" 2
...
# 4 "../Hardware/pwm/pwm.h" 2
# 14 "../Hardware/pwm/pwm.h"
void pwm_config(void);
# 2 "../Hardware/pwm/pwm.c" 2
void pwm_config(void)
{
 rcu_periph_clock_enable(RCU_GPIOB);
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(1))));
    gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)),((uint32_t)((uint32_t)0x01U<<(1))));
    gpio_af_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(1))));
    ...
    timer_deinit(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00002000U));
    ...
    timer_init(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00002000U),&timer_initpara);
    ...
    timer_channel_output_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00002000U),((uint16_t)0x0000U),&timer_ocintpara);
  timer_channel_output_pulse_value_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00002000U),((uint16_t)0x0000U),2500);;

    timer_channel_output_mode_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00002000U),((uint16_t)0x0000U),((uint16_t)0x0060U));
    timer_channel_output_shadow_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00002000U),((uint16_t)0x0000U),((uint16_t)0x0008U));


    timer_auto_reload_shadow_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00002000U));

    timer_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00002000U));
    BUZZER(0);
}
