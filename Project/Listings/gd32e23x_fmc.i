# 1 "../Basic/Source/gd32e23x_fmc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Basic/Source/gd32e23x_fmc.c" 2
# 37 "../Basic/Source/gd32e23x_fmc.c"
...
# 38 "../Basic/Source/gd32e23x_fmc.c" 2
# 51 "../Basic/Source/gd32e23x_fmc.c"
void fmc_unlock(void)
{
...
# 127 "../Basic/Source/gd32e23x_fmc.c"
fmc_state_enum fmc_page_erase(uint32_t page_address)
{
...
# 161 "../Basic/Source/gd32e23x_fmc.c"
fmc_state_enum fmc_mass_erase(void)
{
    fmc_state_enum fmc_state = fmc_ready_wait(((uint32_t)0x000F0000U));
...
# 196 "../Basic/Source/gd32e23x_fmc.c"
fmc_state_enum fmc_doubleword_program(uint32_t address, uint64_t data)
{
...
# 239 "../Basic/Source/gd32e23x_fmc.c"
fmc_state_enum fmc_word_program(uint32_t address, uint32_t data)
{
    fmc_state_enum fmc_state = fmc_ready_wait(((uint32_t)0x000F0000U));
...
# 266 "../Basic/Source/gd32e23x_fmc.c"
void ob_unlock(void)
{
...
# 285 "../Basic/Source/gd32e23x_fmc.c"
void ob_lock(void)
{
...
# 311 "../Basic/Source/gd32e23x_fmc.c"
uint32_t option_byte_value_get(uint32_t addr)
{
    return *(volatile uint32_t *)(addr);
}
# 330 "../Basic/Source/gd32e23x_fmc.c"
fmc_state_enum ob_erase(void)
{
    uint16_t fmc_spc;
    uint32_t val;
...
# 398 "../Basic/Source/gd32e23x_fmc.c"
fmc_state_enum ob_write_protection_enable(uint16_t ob_wp)
{
...
# 443 "../Basic/Source/gd32e23x_fmc.c"
fmc_state_enum ob_security_protection_config(uint16_t ob_spc)
{
    uint32_t val;
    fmc_state_enum fmc_state = fmc_ready_wait(((uint32_t)0x000F0000U));
...
# 515 "../Basic/Source/gd32e23x_fmc.c"
fmc_state_enum ob_user_write(uint8_t ob_user)
{
...
# 576 "../Basic/Source/gd32e23x_fmc.c"
fmc_state_enum ob_data_program(uint16_t data)
{
    fmc_state_enum fmc_state = fmc_ready_wait(((uint32_t)0x000F0000U));
    uint32_t val = 0U;
...
# 761 "../Basic/Source/gd32e23x_fmc.c"
void fmc_interrupt_flag_clear(uint32_t int_flag)
{
