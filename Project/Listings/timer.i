...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Hardware/timer/timer.c" 2
# 1 "../Hardware/timer/timer.h" 1
...
# 5 "../Hardware/timer/timer.h" 2
# 14 "../Hardware/timer/timer.h"
void timer_config(void);
# 2 "../Hardware/timer/timer.c" 2
void timer_config(void)
{
  rcu_periph_clock_enable(RCU_GPIOB);
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(5))));
    ...
    gpio_af_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(5))));
    ...
    timer_channel_output_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U),((uint16_t)0x0001U),&timer_ocintpara);

    timer_channel_output_pulse_value_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U),((uint16_t)0x0001U),0);
    timer_channel_output_mode_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U),((uint16_t)0x0001U),((uint16_t)0x0060U));
    timer_channel_output_shadow_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U),((uint16_t)0x0001U),((uint16_t)0x0008U));
